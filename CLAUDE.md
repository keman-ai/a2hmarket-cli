...
| `--auth-api-url` | 鉴权 API base URL，用于获取凭证 | `https://api.qianmiao.life` |
...
|------|------|--------|
| `--code` | 鉴权 code（必需） | - |
| `--base-url` | 鉴权 API base URL | `https://api.qianmiao.life` |
...
3. **网络要求**: 需要能访问 `https://api.qianmiao.life` 和 `https://a2hmarket.ai`
